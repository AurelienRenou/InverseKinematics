...
biorbd_model_path = Path("../example/wu_converted_definitif_inverse_kinematics.bioMod")
c3d_path_file = Path("../example/F0_aisselle_05.c3d")
...
c3d_data = C3dData(str(c3d_path_file.absolute()), biorbd_model)
markers_data = c3d_data.trajectories
nb_frames = c3d_data.nb_frames
